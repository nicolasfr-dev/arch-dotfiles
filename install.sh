...
# NAO aplicamos o tema do Zen aqui, de proposito.
#
# Ele quebra o hover-to-expand da sidebar: com tudo desligado o hover volta,
# com os arquivos aplicados ele para. A causa exata nunca foi isolada -- so
# sabemos que esta em config/zen/ (user.js ou userChrome.css).
#
# Os arquivos continuam no repo para quem quiser retomar a bissecao:
#   scripts/zen-theme.sh prefs   so o user.js, sem CSS
#   scripts/zen-theme.sh on      tudo
#   scripts/zen-theme.sh off     remove e limpa os prefs
# Ate isso ser resolvido, o install.sh deixa o Zen intocado.
